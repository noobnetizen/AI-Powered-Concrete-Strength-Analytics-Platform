...
def train_concrete_model():
    ...
    for target_name, y_train, y_test in [('7d', y7_train, y7_test), ('28d', y28_train, y28_test)]:
        ...
        # Save test metrics for the website/deployment
        metrics[target_name] = {
        ...
        print(f"TRAIN SET -> R2: {train_r2:.4f}, MAE: {train_mae:.2f}, RMSE: {train_rmse:.2f}")
        print(f"TEST SET  -> R2: {test_r2:.4f}, MAE: {test_mae:.2f}, RMSE: {test_rmse:.2f}")
